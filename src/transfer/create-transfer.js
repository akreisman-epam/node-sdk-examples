...
var sourceToken = process.argv[5] || "usr-0fb6d624-f18d-480d-b1e7-f48f534bbd75";
var destinationToken = process.argv[6] || "usr-0fb6d624-f18d-480d-b1e7-f48f534bbd75";
...
client.createTransfer({
    "clientTransferId" : new Date().toLocaleString(),
